...
export default function AmbientSounds() {
  ...
  const PLAYLIST: AudioFile[] = [
    {
      id: '1',
      label: t(translations.AMBIENT_SOUNDS.beach),
      uri: mediaMapping['AMBIENT_SOUNDS.BEACH.soundURI'],
      isVideo: false,
    },
    {
      id: '2',
      label: t(translations.AMBIENT_SOUNDS.birds),
      uri: mediaMapping['AMBIENT_SOUNDS.BIRDS.soundURI'],
      isVideo: false,
    },
    {
      id: '3',
      label: t(translations.AMBIENT_SOUNDS.countryRoad),
      uri: mediaMapping['AMBIENT_SOUNDS.COUNTRY_ROAD.soundURI'],
      isVideo: false,
    },
    {
      id: '4',
      label: t(translations.AMBIENT_SOUNDS.crickets),
      uri: mediaMapping['AMBIENT_SOUNDS.CRICKETS.soundURI'],
      isVideo: false,
    },
    {
      id: '5',
      label: t(translations.AMBIENT_SOUNDS.drippingWater),
  ...
  return (
    <Screen
      headerProps={{
        title: t(translations.AMBIENT_SOUNDS.label, { ns: 'tools' }),
