...
export const LovingKindness = () => {
  ...
  return (
    <ScreenWithImageHeader
      ...
      footerProps={{
        mainActionLabel: t(translations.MINDFULNESS.subcategories.LOVING_KINDNESS.actionBtnLabel),
        onMainAction: () => router.push('/tools/mindfulness/loving-kindness/player'),
      }}>
      <Typography>{t(translations.MINDFULNESS.subcategories.LOVING_KINDNESS.description)}</Typography>
    </ScreenWithImageHeader>
  );
};
