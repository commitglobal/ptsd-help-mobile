...
export const SenseAwareness = () => {
  ...
  return (
    <ScreenWithImageHeader
      ...
      footerProps={{
        mainActionLabel: t(translations.MINDFULNESS.subcategories.SENSE_AWARENESS.actionBtnLabel),
        onMainAction: () => router.push('/tools/mindfulness/sense-awareness/player'),
      }}>
      <Typography>{t(translations.MINDFULNESS.subcategories.SENSE_AWARENESS.description)}</Typography>
    </ScreenWithImageHeader>
  );
};
