...
export default function ReconnectWithPartner() {
  ...
  const items = t(translations.RELATIONSHIPS.subcategories.RECONNECT_WITH_PARTNER.repeater, {
    returnObjects: true,
  }) as Record<string, { title: string; description: string }>;

  return (
    <ScreenWithChangingText
      staticText={t(translations.RELATIONSHIPS.subcategories.RECONNECT_WITH_PARTNER.helper)}
      ...
      headerProps={{
        title: t(translations.RELATIONSHIPS.subcategories.RECONNECT_WITH_PARTNER.label),
