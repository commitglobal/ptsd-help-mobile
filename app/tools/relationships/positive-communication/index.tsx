...
const PositiveCommunication = () => {
  ...
  const items = t(translations.RELATIONSHIPS.subcategories.POSITIVE_COMMUNICATION.repeater, {
    returnObjects: true,
  }) as Record<string, { title: string; description: string }>;

  return (
    <ScreenWithChangingText
      staticText={t(translations.RELATIONSHIPS.subcategories.POSITIVE_COMMUNICATION.helper)}
