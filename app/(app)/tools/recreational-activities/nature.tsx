...
const RecreationalActivitiesNature = () => {
  ...
  return (
    <ScreenWithChangingText
      headerProps={{
        title: t(toolsTranslationKeys.RECREATIONAL_ACTIVITIES.subcategories.RECREATIONAL_ACTIVITIES_NATURE.title),
...
export default RecreationalActivitiesNature;
